...
DATA_DIR = '/home/sudharsan/Downloads/improved-wgan-pytorch/flowers/' # Replace your image data path here
VAL_DIR = '/home/sudharsan/Downloads/improved-wgan-pytorch/flowers/'
IMAGE_DATA_SET = 'raw' 
...
TRAINING_CLASS = ['rose'] # IGNORE this if you are NOT training on lsun, or if you want to train on other classes of lsun, then change it accordingly
VAL_CLASS = ['rose_val'] # IGNORE this if you are NOT training on lsun, or if you want to train on other classes of lsun, then change it accordingly
...
OUTPUT_PATH = '/home/sudharsan/Downloads/improved-wgan-pytorch/output' # output path where result (.e.g drawing images, cost, chart) will be stored
# MODE = 'wgan-gp'
DIM = 64 # Model dimensionality
CRITIC_ITERS = 5 # How many iterations to train the critic for
GENER_ITERS = 1
N_GPUS = 1 # Number of GPUs
BATCH_SIZE = 24# Batch size. Must be a multiple of N_GPUS
